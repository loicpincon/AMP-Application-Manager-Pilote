package organisation.application.manager.pilote.commun.exception;
...
import organisation.application.manager.pilote.commun.modele.Retour;
...
public class GlobalErrorApplicationHandler extends AbstractHandlerExceptionResolver {
	...
	private ModelAndView handleIllegalArgument(Exception exc, HttpStatus ex, HttpServletResponse response) {
		try {
			...
			response.setContentType("organisation.application/json");
