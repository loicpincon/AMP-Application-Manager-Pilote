...
public class DockerJarDeployer extends DefaultDeployer<WarApplication> {
	...
	public void run() {
		...
		executionScript(scriptPathHelper.getPathOfFile("", "deploiement_jar_gcp"), genererCheminTemporaire(),
				genererCheminTemporaire() + SLASH + app.getBaseName(), genererCheminTemporaire() + SLASH + "ROOT.jar",
